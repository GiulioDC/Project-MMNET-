...
// in simulator we redefine to format for idea Developer console
...
{\
	NSString * exceptionName = [@"org.idea." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.idea";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIideaNativeItemNone = -1, 
	UIideaNativeItemSpinner = -2,
	UIideaNativeItemProgressBar = -3,
	
	UIideaNativeItemSlider = -4,
	UIideaNativeItemSwitch = -5,
	UIideaNativeItemMultiButton = -6,
	UIideaNativeItemSegmented = -7,
	
	UIideaNativeItemTextView = -8,
	UIideaNativeItemTextField = -9,
	UIideaNativeItemSearchBar = -10,
	
	UIideaNativeItemPicker = -11,
	UIideaNativeItemDatePicker = -12,
	
	UIideaNativeItemInfoLight = -13,
	UIideaNativeItemInfoDark = -14,
	
	UIideaNativeItemDisclosure = -15,
	
	UIideaNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all idea instances of
